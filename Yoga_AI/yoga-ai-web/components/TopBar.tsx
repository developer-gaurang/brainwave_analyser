        ...
        <div className="absolute top-4 left-0 w-full z-30 flex justify-center pointer-events-none">
            ...
            ">
                ...
                <div className="flex items-center gap-2 group">
                    ...
                    <div className="flex flex-col leading-none">
                        <span className="text-[8px] text-white/40 uppercase font-bold tracking-widest">Level</span>
                        <div className="flex items-center gap-2">
                            <span className="text-yellow-300 text-sm font-bold shadow-yellow-500/20 drop-shadow-sm">{level}</span>
