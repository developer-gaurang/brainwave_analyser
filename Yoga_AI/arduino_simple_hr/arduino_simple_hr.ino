...
void setup() {
  ...
  // [REVERT] Back to 27.1mA (Standard) - 50mA was too strong (saturation)
...
void loop() {
  ...
  // Relaxed to 2.0 seconds (was 1.0s) to prevent dropping out on missed beats
  ...
  // [FIX] Auto-Recovery: If sensor freezes (no beats for 5s), try to revive it
  // Faster recovery (was 10s)
